      ...
      <div class="card card-body bg-info text-white mb-3">
        <div class="row">
          <div class="col-4 col-md-2 m-auto">
            <img class="rounded-circle" v-if="profile.user" :src="profile.user.avatar" alt="avatar">
          </div>
        </div>
        <div class="text-center">
          ...
          <p>
            ...
            <a v-if="profile.githubusername" class="text-white p-2" :href="`http://github.com/${profile.githubusername}`">
              <i class="fab fa-github fa-2x"></i>
            </a>
            <a v-if="profile.social && profile.social.wechat" class="text-white p-2" :href="profile.social.wechat">
              <i class="fab fa-weixin fa-2x"></i>
            </a>
            <a v-if='profile.social && profile.social.QQ' class="text-white p-2" :href="profile.social.QQ">
